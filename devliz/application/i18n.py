...
_translations: dict[str, dict[str, str]] = {
        ...
        "dashboard.application.started": {"it": "applicazione avviata"},
        "dashboard.f5.pressed": {"it": "F5 premuto"},
        "dashboard.refresh.started": {"it": "aggiornamento dashboard avviato"},
        "dashboard.refresh.completed": {"it": "aggiornamento dashboard completato"},
        "dashboard.data.loaded": {"it": "dati dashboard caricati"},
        "dashboard.page.changed": {"it": "pagina cambiata"},
        "search.page.opened": {"it": "schermata cerca aperta"},
        "catalogue.config.dialog.opened": {"it": "dialog configurazione aperto"},
        "catalogue.snapshot.created": {"it": "snapshot creato"},
        "catalogue.snapshot.updated": {"it": "snapshot modificato"},
        "catalogue.snapshot.installed": {"it": "snapshot installato"},
        "catalogue.snapshot.deleted": {"it": "snapshot eliminato"},
        "catalogue.snapshot.duplicated": {"it": "snapshot duplicato"},
        "catalogue.snapshot.exported": {"it": "snapshot esportato"},
        "catalogue.associated.folders.exported": {"it": "cartelle associate esportate"},
        "catalogue.installed.folders.deleted": {"it": "cartelle installate eliminate"},
        "catalogue.associated.folders.updated": {"it": "cartelle associate aggiornate"},
        "search.snapshot.removed": {"it": "snapshot rimosso dalla ricerca"},
        "search.started": {"it": "ricerca avviata"},
        "search.stopped": {"it": "ricerca fermata"},
        "search.completed": {"it": "ricerca completata"},
        "settings.restart.confirmed": {"it": "riavvio confermato"},
        "settings.catalogue.path.changed": {"it": "percorso catalogo modificato"},
        "settings.backup.cleaned": {"it": "backup pulito"},
        "help.card.opened": {"it": "card aiuto aperta"},
